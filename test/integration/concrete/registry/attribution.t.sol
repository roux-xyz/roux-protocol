...
contract Attribution_Registry_Integration_Concrete_Test is ControllerBase {
    ...
    function test__Attribution() external {
        ...
        (address parentEdition, uint256 parentTokenId, uint256 idx) =
            registry.attribution(address(forkEdition), forkTokenId);
    ...
    function test__Attribution_TwoForks() external {
        ...
        (address parentEdition, uint256 parentTokenId, uint256 idx) =
            registry.attribution(address(fork2Edition), fork2TokenId);
