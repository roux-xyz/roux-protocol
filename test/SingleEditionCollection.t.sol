...
//         _createSingleEditionCollectionWithParams(invalidItemTarget, invalidItemIds);
//     }
...
//         vm.expectRevert(ErrorsLib.Collection_InvalidItems.selector);
//         _createSingleEditionCollectionWithParams(address(edition), invalidItemIds);
//     }
...
//         assertTrue(collection.supportsInterface(type(ICollection).interfaceId), "Should support ICollection
// interface");
