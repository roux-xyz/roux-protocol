...
//             TEST_TOKEN_URI, users.creator_0, users.creator_0, TEST_PROFIT_SHARE, address(0), 0, optionalSaleData
//         );

//         /* add new item to collection */
//         address[] memory collectionItemTargets = new address[](2);
//         collectionItemTargets[0] = address(edition);
//         collectionItemTargets[1] = newEdition;
...
//         assertEq(itemTargets[2], newEdition, "collection item target 2");
...
//         assertEq(RouxEdition(newEdition).balanceOf(account, 1), 1, "new 1155 balanceOf id 1");
//     }
// }
