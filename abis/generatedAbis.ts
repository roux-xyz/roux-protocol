...
export const rouxCommunityEditionAbi = [
  {
    type: 'constructor',
    inputs: [
      { name: 'editionFactory', internalType: 'address', type: 'address' },
  ...
  },
  {
    type: 'function',
    inputs: [
      { name: 'addWindowStart', internalType: 'uint40', type: 'uint40' },
      { name: 'addWindowEnd', internalType: 'uint40', type: 'uint40' },
    ],
    name: 'updateAddWindow',
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    type: 'function',
    inputs: [
      { name: 'maxAddsPerAddress_', internalType: 'uint32', type: 'uint32' },
    ],
    name: 'updateMaxAddsPerAddress',
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
    type: 'function',
    inputs: [{ name: 'maxTokens_', internalType: 'uint256', type: 'uint256' }],
  ...
  },
  {
    ...
    name: 'CommunityAllowlistEnabled',
  },
  {
    type: 'event',
    anonymous: false,
  ...
  { type: 'error', inputs: [], name: 'NotOwnerNorApproved' },
  { type: 'error', inputs: [], name: 'Reentrancy' },
  { type: 'error', inputs: [], name: 'RouxCommunityEdition_AddWindowClosed' },
  {
    type: 'error',
    inputs: [],
    name: 'RouxCommunityEdition_ExceedsMaxAddsPerAddress',
  },
  { type: 'error', inputs: [], name: 'RouxCommunityEdition_ExceedsMaxTokens' },
  { type: 'error', inputs: [], name: 'RouxCommunityEdition_InvalidAddWindow' },
  { type: 'error', inputs: [], name: 'RouxCommunityEdition_NotAllowed' },
